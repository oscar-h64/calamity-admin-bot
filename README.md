...
- The following commands:
    ...
    - Note that all commands that take a user accept either a mention or just the ID. Banning will work even if the user is not in the server
...
## Setup
1. Update Config.hs with the settings for your server (the file is commented to assist with this)
